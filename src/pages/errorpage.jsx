  ...
  return (
    <div className="font-lato min-h-screen flex items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full text-center">
        <div className="mb-8">
          <h1 
            className={`font-lato text-6xl font-bold text-indigo-600 sm:text-8xl md:text-9xl
          ...
          <div className="mt-8 p-4 bg-indigo-50 rounded-lg">
            <p className="font-lato text-indigo-700 font-medium">
        ...
        <Link 
          ...
          className="inline-flex items-center justify-center px-5 py-3 border 
            ...
            bg-indigo-600 hover:bg-indigo-700 sm:text-lg
