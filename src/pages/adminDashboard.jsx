  ...
  <div className="font-lato min-h-screen bg-gray-50 p-3 sm:p-6 lg:p-8">
    <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
        ...
        <p className="text-sm sm:text-base text-gray-600">Role: {adminDetails?.role}</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
        <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
          ...
          >
            {loading ? 'Generating...' : 'Generate Temporary Token'}
          </button>
        ...
        {linkCopied && (
          <p className="mt-2 text-xs sm:text-sm text-green-600">Link copied!</p>
        )}
      </div>
